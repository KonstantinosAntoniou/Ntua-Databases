                ...
                <Table className={classes.table} size="small">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell align='left'><b>No. of Beds</b></TableCell>
                            <TableCell align='left'><b>Name of the Room</b></TableCell>
                    ...
                    <TableBody>
                        {list && list.map(session => (
                            <TableRow key={session.SessionID}>
                                ...
                                <TableCell>{session.number_of_beds}</TableCell>
...
export default function ExposedAreas() {
    ...
    const loadData = async () => {
        ...
        const url = 'http://localhost:8765/db/api/rooms/';
        axios.get(url, {
            headers: {
            }
        }).then(response => {
